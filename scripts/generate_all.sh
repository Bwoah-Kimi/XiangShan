...
#   python3 scripts/parser.py $module --config MyMinimalConfig --prefix Jan15_ --no-extra-files  --xs-home $(pwd) > generate_$module.log
...
for module in {CoupledL2,XSTop,XSTile,XSCore,Frontend,CtrlBlock,ExuBlock,ExuBlock_1,MemBlock,HuanCun,HuanCun_1}; do
  python3 scripts/parser.py $module --config MyMinimalConfig --prefix Mar02_ --no-extra-files  --xs-home $(pwd) > Mar02_sep_rtl/generate_$module.log
