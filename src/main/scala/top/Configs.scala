            ...
            HCCacheParameters(
              ...
              clientCaches = Seq(
                CacheParameters(
                  ...
                  ways = p.dcacheParametersOpt.get.nWays + 2,
                  blockGranularity =
                    log2Ceil(2 * p.dcacheParametersOpt.get.nSets / banks),
          ...
          HCCacheParameters(
            ...
            clientCaches = tiles.map { core =>
              ...
              l2params.copy(
                ...
                blockGranularity = log2Ceil(
                  clientDirBytes / core.L2NBanks / l2params.ways / 64 / tiles.size
                )
              )
            },
            enablePerf = true,
