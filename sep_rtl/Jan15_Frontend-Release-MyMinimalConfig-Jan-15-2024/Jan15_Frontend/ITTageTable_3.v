...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_1031 = {{29'd0}, io_req_bits_folded_hist_hist_7_folded_hist}; // @[ITTAGE.scala 187:31]
  wire [37:0] _idx_T = s0_unhashed_idx ^ _GEN_1031; // @[ITTAGE.scala 187:31]
  wire [8:0] s0_idx = _idx_T[8:0]; // @[ITTAGE.scala 187:40]
  wire [28:0] _GEN_1032 = {{20'd0}, io_req_bits_folded_hist_hist_7_folded_hist}; // @[ITTAGE.scala 188:52]
  wire [28:0] _tag_T_1 = s0_unhashed_idx[37:9] ^ _GEN_1032; // @[ITTAGE.scala 188:52]
  wire [8:0] _tag_T_2 = {io_req_bits_folded_hist_hist_0_folded_hist, 1'h0}; // @[ITTAGE.scala 188:75]
  ...
  wire [37:0] _GEN_1034 = {{29'd0}, io_update_folded_hist_hist_7_folded_hist}; // @[ITTAGE.scala 187:31]
  wire [37:0] _idx_T_1 = io_update_pc[38:1] ^ _GEN_1034; // @[ITTAGE.scala 187:31]
  wire [8:0] update_idx = _idx_T_1[8:0]; // @[ITTAGE.scala 187:40]
  wire [28:0] _GEN_1035 = {{20'd0}, io_update_folded_hist_hist_7_folded_hist}; // @[ITTAGE.scala 188:52]
  wire [28:0] _tag_T_5 = io_update_pc[38:10] ^ _GEN_1035; // @[ITTAGE.scala 188:52]
  wire [8:0] _tag_T_6 = {io_update_folded_hist_hist_0_folded_hist, 1'h0}; // @[ITTAGE.scala 188:75]
