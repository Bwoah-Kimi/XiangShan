module SRAMTemplate(
  ...
  output [24:0] io_rresp_data_0,
  output [24:0] io_rresp_data_1,
  output [24:0] io_rresp_data_2,
  output [24:0] io_rresp_data_3,
  input         io_wreq_valid,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [24:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 105:26]
  wire [24:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 105:26]
  wire [24:0] array_RW0_rdata_2; // @[SRAMTemplate.scala 105:26]
  wire [24:0] array_RW0_rdata_3; // @[SRAMTemplate.scala 105:26]
  ...
  reg [24:0] rdata_hold_data_0; // @[Reg.scala 16:16]
  reg [24:0] rdata_hold_data_1; // @[Reg.scala 16:16]
  reg [24:0] rdata_hold_data_2; // @[Reg.scala 16:16]
  reg [24:0] rdata_hold_data_3; // @[Reg.scala 16:16]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_3 = {1{`RANDOM}};
  rdata_hold_data_0 = _RAND_3[24:0];
  _RAND_4 = {1{`RANDOM}};
  rdata_hold_data_1 = _RAND_4[24:0];
  _RAND_5 = {1{`RANDOM}};
  rdata_hold_data_2 = _RAND_5[24:0];
  _RAND_6 = {1{`RANDOM}};
  rdata_hold_data_3 = _RAND_6[24:0];
`endif // RANDOMIZE_REG_INIT
  if (reset) begin
    resetState = 1'h1;
  end
