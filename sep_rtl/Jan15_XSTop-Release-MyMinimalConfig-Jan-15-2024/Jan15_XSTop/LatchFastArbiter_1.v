...
`endif // RANDOMIZE_REG_INIT
  ...
  reg  out_bits_reg_clients; // @[FastArbiter.scala 70:29]
  ...
  wire  _out_bits_reg_T_67 = chosenOH[0] & io_in_0_bits_clients | chosenOH[1] & io_in_1_bits_clients | chosenOH[2] &
  ...
  wire [21:0] _out_bits_reg_T_95 = chosenOH[0] ? io_in_0_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_96 = chosenOH[1] ? io_in_1_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_97 = chosenOH[2] ? io_in_2_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_98 = chosenOH[3] ? io_in_3_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_99 = chosenOH[4] ? io_in_4_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_100 = chosenOH[5] ? io_in_5_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_101 = chosenOH[6] ? io_in_6_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_102 = chosenOH[7] ? io_in_7_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_103 = chosenOH[8] ? io_in_8_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_104 = chosenOH[9] ? io_in_9_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_105 = chosenOH[10] ? io_in_10_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_106 = chosenOH[11] ? io_in_11_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_107 = chosenOH[12] ? io_in_12_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_108 = chosenOH[13] ? io_in_13_bits_tag : 22'h0; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_109 = _out_bits_reg_T_95 | _out_bits_reg_T_96; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_110 = _out_bits_reg_T_109 | _out_bits_reg_T_97; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_111 = _out_bits_reg_T_110 | _out_bits_reg_T_98; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_112 = _out_bits_reg_T_111 | _out_bits_reg_T_99; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_113 = _out_bits_reg_T_112 | _out_bits_reg_T_100; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_114 = _out_bits_reg_T_113 | _out_bits_reg_T_101; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_115 = _out_bits_reg_T_114 | _out_bits_reg_T_102; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_116 = _out_bits_reg_T_115 | _out_bits_reg_T_103; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_117 = _out_bits_reg_T_116 | _out_bits_reg_T_104; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_118 = _out_bits_reg_T_117 | _out_bits_reg_T_105; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_119 = _out_bits_reg_T_118 | _out_bits_reg_T_106; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_120 = _out_bits_reg_T_119 | _out_bits_reg_T_107; // @[Mux.scala 27:73]
  wire [21:0] _out_bits_reg_T_121 = _out_bits_reg_T_120 | _out_bits_reg_T_108; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_122 = chosenOH[0] ? io_in_0_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_123 = chosenOH[1] ? io_in_1_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_124 = chosenOH[2] ? io_in_2_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_125 = chosenOH[3] ? io_in_3_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_126 = chosenOH[4] ? io_in_4_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_127 = chosenOH[5] ? io_in_5_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_128 = chosenOH[6] ? io_in_6_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_129 = chosenOH[7] ? io_in_7_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_130 = chosenOH[8] ? io_in_8_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_131 = chosenOH[9] ? io_in_9_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_132 = chosenOH[10] ? io_in_10_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_133 = chosenOH[11] ? io_in_11_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_134 = chosenOH[12] ? io_in_12_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_135 = chosenOH[13] ? io_in_13_bits_set : 8'h0; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_136 = _out_bits_reg_T_122 | _out_bits_reg_T_123; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_137 = _out_bits_reg_T_136 | _out_bits_reg_T_124; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_138 = _out_bits_reg_T_137 | _out_bits_reg_T_125; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_139 = _out_bits_reg_T_138 | _out_bits_reg_T_126; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_140 = _out_bits_reg_T_139 | _out_bits_reg_T_127; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_141 = _out_bits_reg_T_140 | _out_bits_reg_T_128; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_142 = _out_bits_reg_T_141 | _out_bits_reg_T_129; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_143 = _out_bits_reg_T_142 | _out_bits_reg_T_130; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_144 = _out_bits_reg_T_143 | _out_bits_reg_T_131; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_145 = _out_bits_reg_T_144 | _out_bits_reg_T_132; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_146 = _out_bits_reg_T_145 | _out_bits_reg_T_133; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_147 = _out_bits_reg_T_146 | _out_bits_reg_T_134; // @[Mux.scala 27:73]
  wire [7:0] _out_bits_reg_T_148 = _out_bits_reg_T_147 | _out_bits_reg_T_135; // @[Mux.scala 27:73]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[FastArbiter.scala 90:22]
      out_bits_reg_clients <= 1'h0; // @[FastArbiter.scala 92:18]
    end else if (latch_result) begin // @[FastArbiter.scala 70:29]
...
`ifdef RANDOMIZE_REG_INIT
  ...
  _RAND_1 = {1{`RANDOM}};
  out_bits_reg_set = _RAND_1[7:0];
  _RAND_2 = {1{`RANDOM}};
  out_bits_reg_tag = _RAND_2[21:0];
  _RAND_3 = {1{`RANDOM}};
  out_bits_reg_param = _RAND_3[2:0];
  _RAND_4 = {1{`RANDOM}};
  out_bits_reg_clients = _RAND_4[0:0];
  _RAND_5 = {1{`RANDOM}};
