module Queue_160(
  ...
  input  [4:0]   io_enq_bits_task_sourceId,
  ...
  output [4:0]   io_deq_bits_task_sourceId,
...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [4:0] ram_task_sourceId [0:15]; // @[Decoupled.scala 259:95]
  wire  ram_task_sourceId_io_deq_bits_MPORT_en; // @[Decoupled.scala 259:95]
  wire [3:0] ram_task_sourceId_io_deq_bits_MPORT_addr; // @[Decoupled.scala 259:95]
  wire [4:0] ram_task_sourceId_io_deq_bits_MPORT_data; // @[Decoupled.scala 259:95]
  wire [4:0] ram_task_sourceId_MPORT_data; // @[Decoupled.scala 259:95]
  wire [3:0] ram_task_sourceId_MPORT_addr; // @[Decoupled.scala 259:95]
  wire  ram_task_sourceId_MPORT_mask; // @[Decoupled.scala 259:95]
  wire  ram_task_sourceId_MPORT_en; // @[Decoupled.scala 259:95]
  ...
  wire [3:0] ptr_diff = enq_ptr_value - deq_ptr_value; // @[Decoupled.scala 312:32]
  wire [4:0] _io_count_T_1 = maybe_full & ptr_match ? 5'h10 : 5'h0; // @[Decoupled.scala 315:20]
  wire [4:0] _GEN_36 = {{1'd0}, ptr_diff}; // @[Decoupled.scala 315:62]
  ...
  assign ram_task_opcode_MPORT_en = io_enq_ready & io_enq_valid;
  ...
  assign ram_task_param_MPORT_en = io_enq_ready & io_enq_valid;
  assign ram_task_sourceId_io_deq_bits_MPORT_en = 1'h1;
  assign ram_task_sourceId_io_deq_bits_MPORT_addr = deq_ptr_value;
  assign ram_task_sourceId_io_deq_bits_MPORT_data = ram_task_sourceId[ram_task_sourceId_io_deq_bits_MPORT_addr]; // @[Decoupled.scala 259:95]
  assign ram_task_sourceId_MPORT_data = io_enq_bits_task_sourceId;
  assign ram_task_sourceId_MPORT_addr = enq_ptr_value;
  assign ram_task_sourceId_MPORT_mask = 1'h1;
  assign ram_task_sourceId_MPORT_en = io_enq_ready & io_enq_valid;
  ...
  assign ram_task_mshrId_MPORT_en = io_enq_ready & io_enq_valid;
  ...
  assign ram_data_data_MPORT_en = io_enq_ready & io_enq_valid;
  assign io_enq_ready = ~full; // @[Decoupled.scala 289:19]
  assign io_deq_valid = ~empty; // @[Decoupled.scala 288:19]
  assign io_deq_bits_task_opcode = ram_task_opcode_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17]
  assign io_deq_bits_task_param = ram_task_param_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17]
  assign io_deq_bits_task_sourceId = ram_task_sourceId_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17]
  assign io_deq_bits_task_mshrId = ram_task_mshrId_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17]
  assign io_deq_bits_data_data = ram_data_data_io_deq_bits_MPORT_data; // @[Decoupled.scala 296:17]
  assign io_count = _io_count_T_1 | _GEN_36; // @[Decoupled.scala 315:62]
  always @(posedge clock) begin
    ...
    if (ram_task_sourceId_MPORT_en & ram_task_sourceId_MPORT_mask) begin
      ram_task_sourceId[ram_task_sourceId_MPORT_addr] <= ram_task_sourceId_MPORT_data; // @[Decoupled.scala 259:95]
    end
...
`ifdef RANDOMIZE_MEM_INIT
  ...
  for (initvar = 0; initvar < 16; initvar = initvar+1)
    ram_task_opcode[initvar] = _RAND_0[2:0];
  _RAND_1 = {1{`RANDOM}};
  for (initvar = 0; initvar < 16; initvar = initvar+1)
    ram_task_param[initvar] = _RAND_1[2:0];
  _RAND_2 = {1{`RANDOM}};
  for (initvar = 0; initvar < 16; initvar = initvar+1)
    ram_task_sourceId[initvar] = _RAND_2[4:0];
  _RAND_3 = {1{`RANDOM}};
  for (initvar = 0; initvar < 16; initvar = initvar+1)
    ram_task_mshrId[initvar] = _RAND_3[7:0];
  _RAND_4 = {16{`RANDOM}};
  for (initvar = 0; initvar < 16; initvar = initvar+1)
    ram_data_data[initvar] = _RAND_4[511:0];
`endif // RANDOMIZE_MEM_INIT
`ifdef RANDOMIZE_REG_INIT
  _RAND_5 = {1{`RANDOM}};
  enq_ptr_value = _RAND_5[3:0];
  _RAND_6 = {1{`RANDOM}};
  deq_ptr_value = _RAND_6[3:0];
  _RAND_7 = {1{`RANDOM}};
