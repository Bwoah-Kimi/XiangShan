module SelectPolicy_2(
  ...
  wire  matrix__1_0 = ~(|emptyVec_0); // @[BitUtils.scala 258:50]
  ...
  wire  sel__1 = emptyVec_1 & matrix__1_0; // @[BitUtils.scala 275:62]
  wire  sel__2 = emptyVec_2 & matrix__2_0; // @[BitUtils.scala 275:62]
  wire  sel__3 = emptyVec_3 & matrix__3_0; // @[BitUtils.scala 275:62]
  wire  sel__4 = emptyVec_4 & matrix__4_0; // @[BitUtils.scala 275:62]
  wire  sel__5 = emptyVec_5 & matrix__5_0; // @[BitUtils.scala 275:62]
  wire  sel__6 = emptyVec_6 & matrix__6_0; // @[BitUtils.scala 275:62]
  wire  sel__7 = emptyVec_7 & matrix__7_0; // @[BitUtils.scala 275:62]
  ...
  wire [7:0] _selValid_T_2 = {request_7,request_6,request_5,request_4,request_3,request_2,request_1,request_0}; // @[BitUtils.scala 236:22]
  wire  sel_1_1 = request_1 & matrix_2_1_0; // @[BitUtils.scala 275:62]
  wire  sel_1_2 = request_2 & matrix_2_2_0; // @[BitUtils.scala 275:62]
  wire  sel_1_3 = request_3 & matrix_2_3_0; // @[BitUtils.scala 275:62]
  wire  sel_1_4 = request_4 & matrix_2_4_0; // @[BitUtils.scala 275:62]
  wire  sel_1_5 = request_5 & matrix_2_5_0; // @[BitUtils.scala 275:62]
  wire  sel_1_6 = request_6 & matrix_2_6_0; // @[BitUtils.scala 275:62]
  wire  sel_1_7 = request_7 & matrix_2_7_0; // @[BitUtils.scala 275:62]
  ...
  assign io_grant_0_valid = |_selValid_T_2; // @[BitUtils.scala 236:29]
