...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [8:0] us_io_raddr_0; // @[ITTAGE.scala 223:18]
  wire  us_io_rdata_0; // @[ITTAGE.scala 223:18]
  wire  us_io_wen; // @[ITTAGE.scala 223:18]
  wire [8:0] us_io_waddr; // @[ITTAGE.scala 223:18]
  ...
  wire [7:0] table_banks_0_io_rreq_bits_setIdx; // @[ITTAGE.scala 226:11]
  ...
  wire [7:0] table_banks_0_io_wreq_bits_setIdx; // @[ITTAGE.scala 226:11]
  ...
  wire [7:0] table_banks_1_io_rreq_bits_setIdx; // @[ITTAGE.scala 226:11]
  ...
  wire [7:0] table_banks_1_io_wreq_bits_setIdx; // @[ITTAGE.scala 226:11]
  ...
  wire [8:0] wrbypass_io_write_idx; // @[ITTAGE.scala 277:24]
  ...
  reg [511:0] validArray; // @[ITTAGE.scala 206:27]
  wire [37:0] s0_unhashed_idx = io_req_bits_pc[38:1]; // @[ITTAGE.scala 213:43]
  wire [37:0] _GEN_1031 = {{29'd0}, io_req_bits_folded_hist_hist_10_folded_hist}; // @[ITTAGE.scala 187:31]
  wire [37:0] _idx_T = s0_unhashed_idx ^ _GEN_1031; // @[ITTAGE.scala 187:31]
  wire [8:0] s0_idx = _idx_T[8:0]; // @[ITTAGE.scala 187:40]
  wire [28:0] _GEN_1032 = {{20'd0}, io_req_bits_folded_hist_hist_10_folded_hist}; // @[ITTAGE.scala 188:52]
  wire [28:0] _tag_T_1 = s0_unhashed_idx[37:9] ^ _GEN_1032; // @[ITTAGE.scala 188:52]
  wire [8:0] _tag_T_2 = {io_req_bits_folded_hist_hist_1_folded_hist, 1'h0}; // @[ITTAGE.scala 188:75]
  wire [28:0] _GEN_1033 = {{20'd0}, _tag_T_2}; // @[ITTAGE.scala 188:61]
  wire [28:0] _tag_T_3 = _tag_T_1 ^ _GEN_1033; // @[ITTAGE.scala 188:61]
  ...
  wire [511:0] _s1_req_rhit_T = validArray >> s1_idx; // @[ITTAGE.scala 238:31]
  ...
  wire [37:0] _GEN_1034 = {{29'd0}, io_update_folded_hist_hist_10_folded_hist}; // @[ITTAGE.scala 187:31]
  wire [37:0] _idx_T_1 = io_update_pc[38:1] ^ _GEN_1034; // @[ITTAGE.scala 187:31]
  wire [8:0] update_idx = _idx_T_1[8:0]; // @[ITTAGE.scala 187:40]
  wire [28:0] _GEN_1035 = {{20'd0}, io_update_folded_hist_hist_10_folded_hist}; // @[ITTAGE.scala 188:52]
  wire [28:0] _tag_T_5 = io_update_pc[38:10] ^ _GEN_1035; // @[ITTAGE.scala 188:52]
  wire [8:0] _tag_T_6 = {io_update_folded_hist_hist_1_folded_hist, 1'h0}; // @[ITTAGE.scala 188:75]
  wire [28:0] _GEN_1036 = {{20'd0}, _tag_T_6}; // @[ITTAGE.scala 188:61]
  wire [28:0] _tag_T_7 = _tag_T_5 ^ _GEN_1036; // @[ITTAGE.scala 188:61]
  ...
  Folded1WDataModuleTemplate_2 us ( // @[ITTAGE.scala 223:18]
    .clock(us_clock),
    .reset(us_reset),
  ...
  FoldedSRAMTemplate_40 table_banks_0 ( // @[ITTAGE.scala 226:11]
  ...
  FoldedSRAMTemplate_40 table_banks_1 ( // @[ITTAGE.scala 226:11]
  ...
  WrBypass_75 wrbypass ( // @[ITTAGE.scala 277:24]
  ...
  assign us_io_raddr_0 = _idx_T[8:0]; // @[ITTAGE.scala 187:40]
  assign us_io_wen = io_update_uValid; // @[ITTAGE.scala 273:13]
  assign us_io_waddr = _idx_T_1[8:0]; // @[ITTAGE.scala 187:40]
  ...
  assign table_banks_0_io_rreq_bits_setIdx = s0_idx[8:1]; // @[ITTAGE.scala 167:37]
  assign table_banks_0_io_wreq_valid = io_update_valid & update_req_bank_1h_0; // @[ITTAGE.scala 261:33]
  assign table_banks_0_io_wreq_bits_setIdx = update_idx[8:1]; // @[ITTAGE.scala 167:37]
  ...
  assign table_banks_1_io_rreq_bits_setIdx = s0_idx[8:1]; // @[ITTAGE.scala 167:37]
  assign table_banks_1_io_wreq_valid = io_update_valid & update_idx[0]; // @[ITTAGE.scala 261:33]
  assign table_banks_1_io_wreq_bits_setIdx = update_idx[8:1]; // @[ITTAGE.scala 167:37]
  ...
  assign wrbypass_io_write_idx = _idx_T_1[8:0]; // @[ITTAGE.scala 187:40]
