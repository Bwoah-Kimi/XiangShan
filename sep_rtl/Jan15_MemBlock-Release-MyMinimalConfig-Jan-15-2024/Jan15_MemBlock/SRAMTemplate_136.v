module SRAMTemplate_136(
  ...
  output [7:0] io_rresp_data_4,
  output [7:0] io_rresp_data_5,
  output [7:0] io_rresp_data_6,
  output [7:0] io_rresp_data_7,
  input        io_wreq_valid,
  ...
  input  [7:0] io_wreq_bits_data_4,
  input  [7:0] io_wreq_bits_data_5,
  input  [7:0] io_wreq_bits_data_6,
  input  [7:0] io_wreq_bits_data_7,
  ...
  wire [7:0] array_RW0_wdata_1; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_wdata_2; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_wdata_3; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_wdata_4; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_wdata_5; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_wdata_6; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_wdata_7; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_0; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_1; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_2; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_3; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_4; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_5; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_6; // @[SRAMTemplate.scala 105:26]
  wire [7:0] array_RW0_rdata_7; // @[SRAMTemplate.scala 105:26]
