module TLBSA_1(
  ...
  output        io_rresp_1_bits_perm_0_pm_0_w,
...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  entries_io_rdata_1_0_perm_d; // @[TLBStorage.scala 249:23]
  wire  entries_io_rdata_1_0_perm_a; // @[TLBStorage.scala 249:23]
  wire  entries_io_rdata_1_0_perm_u; // @[TLBStorage.scala 249:23]
  wire  entries_io_rdata_1_0_perm_w; // @[TLBStorage.scala 249:23]
  wire  entries_io_rdata_1_0_perm_pm_w; // @[TLBStorage.scala 249:23]
  ...
  wire  _GEN_86 = 4'h0 == io_victim_in_bits_entry_tag[3:0] | v_0_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_87 = 4'h1 == io_victim_in_bits_entry_tag[3:0] | v_1_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_88 = 4'h2 == io_victim_in_bits_entry_tag[3:0] | v_2_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_89 = 4'h3 == io_victim_in_bits_entry_tag[3:0] | v_3_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_90 = 4'h4 == io_victim_in_bits_entry_tag[3:0] | v_4_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_91 = 4'h5 == io_victim_in_bits_entry_tag[3:0] | v_5_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_92 = 4'h6 == io_victim_in_bits_entry_tag[3:0] | v_6_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_93 = 4'h7 == io_victim_in_bits_entry_tag[3:0] | v_7_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_94 = 4'h8 == io_victim_in_bits_entry_tag[3:0] | v_8_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_95 = 4'h9 == io_victim_in_bits_entry_tag[3:0] | v_9_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_96 = 4'ha == io_victim_in_bits_entry_tag[3:0] | v_10_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_97 = 4'hb == io_victim_in_bits_entry_tag[3:0] | v_11_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_98 = 4'hc == io_victim_in_bits_entry_tag[3:0] | v_12_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_99 = 4'hd == io_victim_in_bits_entry_tag[3:0] | v_13_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_100 = 4'he == io_victim_in_bits_entry_tag[3:0] | v_14_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_101 = 4'hf == io_victim_in_bits_entry_tag[3:0] | v_15_0; // @[TLBStorage.scala 248:18 305:{74,74}]
  wire  _GEN_102 = io_victim_in_valid ? _GEN_86 : v_0_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_103 = io_victim_in_valid ? _GEN_87 : v_1_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_104 = io_victim_in_valid ? _GEN_88 : v_2_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_105 = io_victim_in_valid ? _GEN_89 : v_3_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_106 = io_victim_in_valid ? _GEN_90 : v_4_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_107 = io_victim_in_valid ? _GEN_91 : v_5_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_108 = io_victim_in_valid ? _GEN_92 : v_6_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_109 = io_victim_in_valid ? _GEN_93 : v_7_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_110 = io_victim_in_valid ? _GEN_94 : v_8_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_111 = io_victim_in_valid ? _GEN_95 : v_9_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_112 = io_victim_in_valid ? _GEN_96 : v_10_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_113 = io_victim_in_valid ? _GEN_97 : v_11_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_114 = io_victim_in_valid ? _GEN_98 : v_12_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_115 = io_victim_in_valid ? _GEN_99 : v_13_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_116 = io_victim_in_valid ? _GEN_100 : v_14_0; // @[TLBStorage.scala 248:18 304:29]
  wire  _GEN_117 = io_victim_in_valid ? _GEN_101 : v_15_0; // @[TLBStorage.scala 248:18 304:29]
  BankedAsyncDataModuleTemplateWithDup_1 entries ( // @[TLBStorage.scala 249:23]
    .clock(entries_clock),
  ...
  assign io_rresp_1_bits_perm_0_d = entries_io_rdata_1_0_perm_d; // @[TLBStorage.scala 273:27]
  ...
  assign io_rresp_1_bits_perm_0_w = entries_io_rdata_1_0_perm_w; // @[TLBStorage.scala 278:27]
  assign io_rresp_1_bits_perm_0_pm_0_w = entries_io_rdata_1_0_perm_pm_w; // @[TLBStorage.scala 281:33]
