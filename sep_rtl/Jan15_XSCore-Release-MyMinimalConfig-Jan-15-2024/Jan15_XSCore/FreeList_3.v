...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [4:0] _deqPtr_new_ptr_T_1 = {{1'd0}, _deqPtr_new_ptr_T}; // @[CircularQueuePtr.scala 39:46]
  wire [2:0] deqPtr_value = _deqPtr_new_ptr_T_1[2:0]; // @[CircularQueuePtr.scala 39:59]
  wire  deqPtr_flag = _deqPtr_new_ptr_T_1[3]; // @[CircularQueuePtr.scala 39:59]
  ...
  wire [2:0] _GEN_65 = 3'h1 == deqPtr_value ? freeList_1 : freeList_0; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_66 = 3'h2 == deqPtr_value ? freeList_2 : _GEN_65; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_67 = 3'h3 == deqPtr_value ? freeList_3 : _GEN_66; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_68 = 3'h4 == deqPtr_value ? freeList_4 : _GEN_67; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_69 = 3'h5 == deqPtr_value ? freeList_5 : _GEN_68; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_70 = 3'h6 == deqPtr_value ? freeList_6 : _GEN_69; // @[FreeList.scala 122:{26,26}]
  wire [3:0] _GEN_85 = {{3'd0}, io_allocateReq_0}; // @[CircularQueuePtr.scala 39:46]
  wire [3:0] _deqPtr_new_ptr_T_7 = _deqPtr_new_ptr_T + _GEN_85; // @[CircularQueuePtr.scala 39:46]
  wire [2:0] deqPtr_1_value = _deqPtr_new_ptr_T_7[2:0]; // @[CircularQueuePtr.scala 39:59]
  wire  deqPtr_1_flag = _deqPtr_new_ptr_T_7[3]; // @[CircularQueuePtr.scala 39:59]
  ...
  wire [2:0] _GEN_73 = 3'h1 == deqPtr_1_value ? freeList_1 : freeList_0; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_74 = 3'h2 == deqPtr_1_value ? freeList_2 : _GEN_73; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_75 = 3'h3 == deqPtr_1_value ? freeList_3 : _GEN_74; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_76 = 3'h4 == deqPtr_1_value ? freeList_4 : _GEN_75; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_77 = 3'h5 == deqPtr_1_value ? freeList_5 : _GEN_76; // @[FreeList.scala 122:{26,26}]
  wire [2:0] _GEN_78 = 3'h6 == deqPtr_1_value ? freeList_6 : _GEN_77; // @[FreeList.scala 122:{26,26}]
  wire [3:0] _GEN_86 = {{2'd0}, numAllocate}; // @[CircularQueuePtr.scala 39:46]
  wire [3:0] _headPtrNext_new_ptr_T_2 = _deqPtr_new_ptr_T + _GEN_86; // @[CircularQueuePtr.scala 39:46]
  wire [2:0] headPtrNext_new_ptr_value = _headPtrNext_new_ptr_T_2[2:0]; // @[CircularQueuePtr.scala 39:59]
  wire  headPtrNext_new_ptr_flag = _headPtrNext_new_ptr_T_2[3]; // @[CircularQueuePtr.scala 39:59]
  assign io_allocateSlot_0 = 3'h7 == deqPtr_value ? freeList_7 : _GEN_70; // @[FreeList.scala 122:{26,26}]
  assign io_allocateSlot_1 = 3'h7 == deqPtr_1_value ? freeList_7 : _GEN_78; // @[FreeList.scala 122:{26,26}]
  assign io_canAllocate_0 = io_canAllocate_0_differentFlag ^ io_canAllocate_0_compare; // @[CircularQueuePtr.scala 74:19]
  assign io_canAllocate_1 = io_canAllocate_1_differentFlag ^ io_canAllocate_1_compare; // @[CircularQueuePtr.scala 74:19]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[FreeList.scala 128:17]
      ...
      headPtr_flag <= headPtrNext_new_ptr_flag;
    end
  end
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[FreeList.scala 128:17]
      ...
      headPtr_value <= headPtrNext_new_ptr_value;
    end
  end
  always @(posedge clock or posedge reset) begin
