...
`endif // RANDOMIZE_REG_INIT
  ...
  reg [2:0] data_mem_0 [0:7]; // @[WrBypass.scala 55:21]
  ...
  wire [2:0] data_mem_0_io_hit_data_0_bits_MPORT_data; // @[WrBypass.scala 55:21]
  wire [2:0] data_mem_0_MPORT_data; // @[WrBypass.scala 55:21]
  ...
  wire  _GEN_8 = 3'h0 == hit_idx | valids_0_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_9 = 3'h1 == hit_idx | valids_1_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_10 = 3'h2 == hit_idx | valids_2_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_11 = 3'h3 == hit_idx | valids_3_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_12 = 3'h4 == hit_idx | valids_4_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_13 = 3'h5 == hit_idx | valids_5_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_14 = 3'h6 == hit_idx | valids_6_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_15 = 3'h7 == hit_idx | valids_7_0; // @[WrBypass.scala 57:23 96:{30,30}]
  wire  _GEN_96 = 3'h0 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_24 = 3'h0 == enq_idx | ever_written_0; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_97 = 3'h1 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_25 = 3'h1 == enq_idx | ever_written_1; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_98 = 3'h2 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_26 = 3'h2 == enq_idx | ever_written_2; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_99 = 3'h3 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_27 = 3'h3 == enq_idx | ever_written_3; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_100 = 3'h4 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_28 = 3'h4 == enq_idx | ever_written_4; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_101 = 3'h5 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_29 = 3'h5 == enq_idx | ever_written_5; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_102 = 3'h6 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_30 = 3'h6 == enq_idx | ever_written_6; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_103 = 3'h7 == enq_idx; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_31 = 3'h7 == enq_idx | ever_written_7; // @[WrBypass.scala 58:29 99:{31,31}]
  wire  _GEN_32 = 3'h0 == enq_idx ? 1'h0 : valids_0_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_33 = 3'h1 == enq_idx ? 1'h0 : valids_1_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_34 = 3'h2 == enq_idx ? 1'h0 : valids_2_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_35 = 3'h3 == enq_idx ? 1'h0 : valids_3_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_36 = 3'h4 == enq_idx ? 1'h0 : valids_4_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_37 = 3'h5 == enq_idx ? 1'h0 : valids_5_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_38 = 3'h6 == enq_idx ? 1'h0 : valids_6_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_39 = 3'h7 == enq_idx ? 1'h0 : valids_7_0; // @[WrBypass.scala 100:{28,28} 57:23]
  wire  _GEN_40 = _GEN_96 | _GEN_32; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_41 = _GEN_97 | _GEN_33; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_42 = _GEN_98 | _GEN_34; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_43 = _GEN_99 | _GEN_35; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_44 = _GEN_100 | _GEN_36; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_45 = _GEN_101 | _GEN_37; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_46 = _GEN_102 | _GEN_38; // @[WrBypass.scala 102:{30,30}]
  wire  _GEN_47 = _GEN_103 | _GEN_39; // @[WrBypass.scala 102:{30,30}]
  CAMTemplate idx_tag_cam ( // @[WrBypass.scala 54:27]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_0_0 <= 1'h0; // @[WrBypass.scala 94:18]
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_1_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_1_0 <= _GEN_9;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_2_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_2_0 <= _GEN_10;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_3_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_3_0 <= _GEN_11;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_4_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_4_0 <= _GEN_12;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_5_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_5_0 <= _GEN_13;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_6_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_6_0 <= _GEN_14;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      valids_7_0 <= 1'h0; // @[WrBypass.scala 94:18]
    end else if (io_wen) begin // @[WrBypass.scala 57:23]
      if (hit) begin
        valids_7_0 <= _GEN_15;
      end else begin
  ...
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      ...
      if (!(hit)) begin
        ever_written_3 <= _GEN_27;
      end
    end
  end
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      ever_written_4 <= 1'h0; // @[WrBypass.scala 94:18 58:29]
    end else if (io_wen) begin // @[WrBypass.scala 58:29]
      if (!(hit)) begin
        ever_written_4 <= _GEN_28;
      end
    end
  end
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      ever_written_5 <= 1'h0; // @[WrBypass.scala 94:18 58:29]
    end else if (io_wen) begin // @[WrBypass.scala 58:29]
      if (!(hit)) begin
        ever_written_5 <= _GEN_29;
      end
    end
  end
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      ever_written_6 <= 1'h0; // @[WrBypass.scala 94:18 58:29]
    end else if (io_wen) begin // @[WrBypass.scala 58:29]
      if (!(hit)) begin
        ever_written_6 <= _GEN_30;
      end
    end
  end
  always @(posedge clock or posedge reset) begin
    if (reset) begin // @[WrBypass.scala 93:19]
      ever_written_7 <= 1'h0; // @[WrBypass.scala 94:18 58:29]
    end else if (io_wen) begin // @[WrBypass.scala 58:29]
      if (!(hit)) begin
        ever_written_7 <= _GEN_31;
      end
    end
  end
  always @(posedge clock or posedge reset) begin
