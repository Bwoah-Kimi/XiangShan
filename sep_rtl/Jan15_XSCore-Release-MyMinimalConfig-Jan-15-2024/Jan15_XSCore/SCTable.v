...
`endif // RANDOMIZE_REG_INIT
  ...
  assign table__io_rreq_bits_setIdx = io_req_bits_pc[8:1]; // @[SC.scala 91:29]
  assign table__io_wreq_valid = io_update_mask_0 | io_update_mask_1; // @[SC.scala 132:36]
  assign table__io_wreq_bits_setIdx = update_unhashed_idx[7:0]; // @[SC.scala 91:29]
  ...
  assign wrbypasses_0_io_write_idx = update_unhashed_idx[7:0]; // @[SC.scala 91:29]
  ...
  assign wrbypasses_1_io_write_idx = update_unhashed_idx[7:0]; // @[SC.scala 91:29]
