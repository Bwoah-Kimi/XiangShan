module FPDecoder(
  ...
  assign io_fpCtrl_isAddSub = decoder_decoded_invMatrixOutputs[8]; // @[Decode.scala 52:77]
  assign io_fpCtrl_typeTagIn = decoder_decoded_invMatrixOutputs[7]; // @[Decode.scala 52:77]
  assign io_fpCtrl_typeTagOut = decoder_decoded_invMatrixOutputs[6]; // @[Decode.scala 52:77]
  assign io_fpCtrl_fromInt = decoder_decoded_invMatrixOutputs[5]; // @[Decode.scala 52:77]
  assign io_fpCtrl_wflags = decoder_decoded_invMatrixOutputs[4]; // @[Decode.scala 52:77]
  assign io_fpCtrl_fpWen = decoder_decoded_invMatrixOutputs[3]; // @[Decode.scala 52:77]
  assign io_fpCtrl_fmaCmd = decoded_invMatrixOutputs[2:1]; // @[Decode.scala 52:77]
  assign io_fpCtrl_div = decoder_decoded_invMatrixOutputs[2]; // @[Decode.scala 52:77]
  assign io_fpCtrl_sqrt = decoder_decoded_invMatrixOutputs[1]; // @[Decode.scala 52:77]
  assign io_fpCtrl_fcvt = decoder_decoded_invMatrixOutputs[0]; // @[Decode.scala 52:77]
  assign io_fpCtrl_typ = io_instr[21:20]; // @[FPDecoder.scala 123:23]
  assign io_fpCtrl_fmt = io_instr[26:25]; // @[FPDecoder.scala 124:23]
  assign io_fpCtrl_ren3 = decoded_invMatrixOutputs[0]; // @[Decode.scala 52:77]
