...
`endif // RANDOMIZE_REG_INIT
  ...
  wire  arb_io_in_2_bits_uop_lqIdx_flag; // @[WbArbiter.scala 213:21]
  wire [3:0] arb_io_in_2_bits_uop_lqIdx_value; // @[WbArbiter.scala 213:21]
  ...
  ExuWbArbiter arb ( // @[WbArbiter.scala 213:21]
    ...
    .io_in_2_bits_uop_lqIdx_flag(arb_io_in_2_bits_uop_lqIdx_flag),
    .io_in_2_bits_uop_lqIdx_value(arb_io_in_2_bits_uop_lqIdx_value),
  ...
  assign io_out_0_bits_uop_lqIdx_flag = io_in_0_bits_uop_lqIdx_flag; // @[WbArbiter.scala 170:16]
  assign io_out_0_bits_uop_lqIdx_value = io_in_0_bits_uop_lqIdx_value; // @[WbArbiter.scala 170:16]
  ...
  assign io_out_1_bits_uop_lqIdx_flag = io_in_1_bits_uop_lqIdx_flag; // @[WbArbiter.scala 170:16]
  assign io_out_1_bits_uop_lqIdx_value = io_in_1_bits_uop_lqIdx_value; // @[WbArbiter.scala 170:16]
  ...
  assign io_out_2_bits_uop_lqIdx_flag = io_in_5_bits_uop_lqIdx_flag; // @[WbArbiter.scala 170:16]
  assign io_out_2_bits_uop_lqIdx_value = io_in_5_bits_uop_lqIdx_value; // @[WbArbiter.scala 170:16]
  ...
  assign io_out_3_bits_uop_lqIdx_flag = io_in_6_bits_uop_lqIdx_flag; // @[WbArbiter.scala 170:16]
  assign io_out_3_bits_uop_lqIdx_value = io_in_6_bits_uop_lqIdx_value; // @[WbArbiter.scala 170:16]
  ...
  assign io_out_4_bits_uop_lqIdx_flag = arb_io_out_bits_uop_lqIdx_flag; // @[WbArbiter.scala 217:14]
  assign io_out_4_bits_uop_lqIdx_value = arb_io_out_bits_uop_lqIdx_value; // @[WbArbiter.scala 217:14]
  ...
  assign shared_buffer_io_in_bits_uop_lqIdx_flag = io_in_4_bits_uop_lqIdx_flag; // @[PipelineConnect.scala 169:23]
  assign shared_buffer_io_in_bits_uop_lqIdx_value = io_in_4_bits_uop_lqIdx_value; // @[PipelineConnect.scala 169:23]
  ...
  assign arb_io_in_1_bits_uop_lqIdx_flag = io_in_3_bits_uop_lqIdx_flag; // @[WbArbiter.scala 215:15]
  assign arb_io_in_1_bits_uop_lqIdx_value = io_in_3_bits_uop_lqIdx_value; // @[WbArbiter.scala 215:15]
  ...
  assign arb_io_in_2_bits_uop_lqIdx_flag = shared_buffer_io_out_bits_uop_lqIdx_flag; // @[PipelineConnect.scala 170:24 WbArbiter.scala 195:31]
  assign arb_io_in_2_bits_uop_lqIdx_value = shared_buffer_io_out_bits_uop_lqIdx_value; // @[PipelineConnect.scala 170:24 WbArbiter.scala 195:31]
