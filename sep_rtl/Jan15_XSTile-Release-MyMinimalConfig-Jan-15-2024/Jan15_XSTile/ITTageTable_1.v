...
`endif // RANDOMIZE_REG_INIT
  ...
  wire [37:0] _GEN_519 = {{30'd0}, io_req_bits_folded_hist_hist_8_folded_hist}; // @[ITTAGE.scala 187:31]
  wire [37:0] _idx_T = s0_unhashed_idx ^ _GEN_519; // @[ITTAGE.scala 187:31]
  wire [7:0] s0_idx = _idx_T[7:0]; // @[ITTAGE.scala 187:40]
  wire [29:0] _GEN_520 = {{22'd0}, io_req_bits_folded_hist_hist_8_folded_hist}; // @[ITTAGE.scala 188:52]
  wire [29:0] _tag_T_1 = s0_unhashed_idx[37:8] ^ _GEN_520; // @[ITTAGE.scala 188:52]
  wire [8:0] _tag_T_2 = {io_req_bits_folded_hist_hist_8_folded_hist, 1'h0}; // @[ITTAGE.scala 188:75]
  wire [29:0] _GEN_521 = {{21'd0}, _tag_T_2}; // @[ITTAGE.scala 188:61]
  ...
  wire [37:0] _GEN_522 = {{30'd0}, io_update_folded_hist_hist_8_folded_hist}; // @[ITTAGE.scala 187:31]
  wire [37:0] _idx_T_1 = io_update_pc[38:1] ^ _GEN_522; // @[ITTAGE.scala 187:31]
  wire [7:0] update_idx = _idx_T_1[7:0]; // @[ITTAGE.scala 187:40]
  wire [29:0] _GEN_523 = {{22'd0}, io_update_folded_hist_hist_8_folded_hist}; // @[ITTAGE.scala 188:52]
  wire [29:0] _tag_T_5 = io_update_pc[38:9] ^ _GEN_523; // @[ITTAGE.scala 188:52]
  wire [8:0] _tag_T_6 = {io_update_folded_hist_hist_8_folded_hist, 1'h0}; // @[ITTAGE.scala 188:75]
  wire [29:0] _GEN_524 = {{21'd0}, _tag_T_6}; // @[ITTAGE.scala 188:61]
